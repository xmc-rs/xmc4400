...
pub type EIGHTX_PBL_R = crate::BitReader<bool>;
#[doc = "Field `EIGHTxPBL` writer - 8xPBL Mode"]
pub type EIGHTX_PBL_W<'a, const O: u8> = crate::BitWriter<'a, u32, BUS_MODE_SPEC, bool, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn eightx_pbl(&self) -> EIGHTX_PBL_R {
        EIGHTX_PBL_R::new(((self.bits >> 24) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eightx_pbl(&mut self) -> EIGHTX_PBL_W<24> {
        EIGHTX_PBL_W::new(self)
    }
    #[doc = "Bit 25 - Address Aligned Beats"]
    #[inline(always)]
    #[must_use]
