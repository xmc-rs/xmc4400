...
pub type EightxPblR = crate::BitReader;
#[doc = "Field `EIGHTxPBL` writer - 8xPBL Mode"]
pub type EightxPblW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn eightx_pbl(&self) -> EightxPblR {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn eightx_pbl(&mut self) -> EightxPblW<BusModeSpec> {
