...
#[doc = "Field `EIGHTxPBL` reader - 8xPBL Mode"]
pub struct EIGHTXPBL_R(crate::FieldReader<bool, bool>);
impl EIGHTXPBL_R {
    pub(crate) fn new(bits: bool) -> Self {
        EIGHTXPBL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EIGHTXPBL_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `EIGHTxPBL` writer - 8xPBL Mode"]
pub struct EIGHTXPBL_W<'a> {
    w: &'a mut W,
}
impl<'a> EIGHTXPBL_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[inline(always)]
    pub fn eightx_pbl(&self) -> EIGHTXPBL_R {
        EIGHTXPBL_R::new(((self.bits >> 24) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 24 - 8xPBL Mode"]
    #[inline(always)]
    pub fn eightx_pbl(&mut self) -> EIGHTXPBL_W {
        EIGHTXPBL_W { w: self }
    }
    #[doc = "Bit 25 - Address Aligned Beats"]
    #[inline(always)]
