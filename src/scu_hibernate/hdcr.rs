...
pub type GPI1SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, HDCR_SPEC, GPI1SEL_A, O>;
impl<'a, const O: u8> GPI1SEL_W<'a, O> {
    #[doc = "HIB_IO_1 pin selected"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
pub type ADIG1SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, HDCR_SPEC, ADIG1SEL_A, O>;
impl<'a, const O: u8> ADIG1SEL_W<'a, O> {
    #[doc = "Digital input"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
pub type AHIBIO1LO_W<'a, const O: u8> = crate::BitWriter<'a, u32, HDCR_SPEC, AHIBIO1LO_A, O>;
impl<'a, const O: u8> AHIBIO1LO_W<'a, O> {
    #[doc = "Wake-up event disabled"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
pub type AHIBIO1HI_W<'a, const O: u8> = crate::BitWriter<'a, u32, HDCR_SPEC, AHIBIO1HI_A, O>;
impl<'a, const O: u8> AHIBIO1HI_W<'a, O> {
    #[doc = "Wake-up event disabled"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpi1sel(&mut self) -> GPI1SEL_W<11> {
        GPI1SEL_W::new(self)
    }
    #[doc = "Bit 12 - HIBIO0 Polarity Set"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn adig1sel(&mut self) -> ADIG1SEL_W<15> {
        ADIG1SEL_W::new(self)
    }
    #[doc = "Bits 16:19 - HIB_IO_0 Pin I/O Control (default HIBOUT)"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahibio1lo(&mut self) -> AHIBIO1LO_W<28> {
        AHIBIO1LO_W::new(self)
    }
    #[doc = "Bit 29 - Wake-Up on Analog HIB_IO_1 Rising Above Threshold Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ahibio1hi(&mut self) -> AHIBIO1HI_W<29> {
        AHIBIO1HI_W::new(self)
    }
