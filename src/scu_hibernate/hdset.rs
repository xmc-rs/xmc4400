...
pub type AHIBIO1PEV_W<'a, const O: u8> = crate::BitWriter<'a, u32, HDSET_SPEC, AHIBIO1PEV_AW, O>;
...
pub type AHIBIO1NEV_W<'a, const O: u8> = crate::BitWriter<'a, u32, HDSET_SPEC, AHIBIO1NEV_AW, O>;
