...
pub type AHIBIO1SCMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPACCLR_SPEC, AHIBIO1SCMP_AW, O>;
...
pub type AHIBIO1VAL_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPACCLR_SPEC, AHIBIO1VAL_AW, O>;
