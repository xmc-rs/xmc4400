...
pub type Ahibio1scmpR = crate::BitReader<Ahibio1scmp>;
impl Ahibio1scmpR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Ahibio1scmp {
        match self.bits {
            false => Ahibio1scmp::Value1,
            true => Ahibio1scmp::Value2,
        }
    }
    #[doc = "Ready to start new compare operation"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        *self == Ahibio1scmp::Value1
    }
    #[doc = "Compare operation completed"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        *self == Ahibio1scmp::Value2
    }
}
...
pub type Ahibio1valR = crate::BitReader<Ahibio1val>;
impl Ahibio1valR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Ahibio1val {
        match self.bits {
            false => Ahibio1val::Value1,
            true => Ahibio1val::Value2,
        }
    }
    #[doc = "Below programmed threshold"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        *self == Ahibio1val::Value1
    }
    #[doc = "Above programmed threshold"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        *self == Ahibio1val::Value2
    }
}
impl R {
    ...
    pub fn ahibio1scmp(&self) -> Ahibio1scmpR {
        Ahibio1scmpR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    pub fn ahibio1val(&self) -> Ahibio1valR {
        Ahibio1valR::new(((self.bits >> 18) & 1) != 0)
    }
}
