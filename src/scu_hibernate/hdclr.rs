...
pub type AHIBIO1PEV_W<'a, REG> = crate::BitWriter<'a, REG, AHIBIO1PEV_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(AHIBIO1PEV_A::VALUE1)
    }
    #[doc = "Clear wake-up event"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(AHIBIO1PEV_A::VALUE2)
    }
}
...
pub type AHIBIO1NEV_W<'a, REG> = crate::BitWriter<'a, REG, AHIBIO1NEV_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(AHIBIO1NEV_A::VALUE1)
    }
    #[doc = "Clear wake-up event"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(AHIBIO1NEV_A::VALUE2)
    }
}
impl W {
    ...
    #[inline(always)]
    pub fn ahibio1pev(&mut self) -> AHIBIO1PEV_W<'_, HDCLR_SPEC> {
        AHIBIO1PEV_W::new(self, 12)
    }
    #[doc = "Bit 13 - Wake-Up on LPAC Negative Edge of HIB_IO_1 Threshold Crossing Clear"]
    #[inline(always)]
    pub fn ahibio1nev(&mut self) -> AHIBIO1NEV_W<'_, HDCLR_SPEC> {
