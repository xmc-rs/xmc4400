...
#[doc = "Trigger HIB_IO_1 Input Single Compare Operation Set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ahibio1scmp {
    #[doc = "0: No effect"]
    Value1 = 0,
    #[doc = "1: Start compare operation"]
    Value2 = 1,
}
impl From<Ahibio1scmp> for bool {
    #[inline(always)]
    fn from(variant: Ahibio1scmp) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `AHIBIO1SCMP` writer - Trigger HIB_IO_1 Input Single Compare Operation Set"]
pub type Ahibio1scmpW<'a, REG> = crate::BitWriter<'a, REG, Ahibio1scmp>;
impl<'a, REG> Ahibio1scmpW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(Ahibio1scmp::Value1)
    }
    #[doc = "Start compare operation"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(Ahibio1scmp::Value2)
    }
}
...
#[doc = "HIB_IO_1 Input Compare Initial Value Set\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ahibio1val {
    #[doc = "0: No effect"]
    Value1 = 0,
...
impl From<Ahibio1val> for bool {
    #[inline(always)]
    fn from(variant: Ahibio1val) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `AHIBIO1VAL` writer - HIB_IO_1 Input Compare Initial Value Set"]
pub type Ahibio1valW<'a, REG> = crate::BitWriter<'a, REG, Ahibio1val>;
impl<'a, REG> Ahibio1valW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(Ahibio1val::Value1)
    }
    #[doc = "Above programmed threshold"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(Ahibio1val::Value2)
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahibio1scmp(&mut self) -> Ahibio1scmpW<LpacsetSpec> {
        Ahibio1scmpW::new(self, 2)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahibio1val(&mut self) -> Ahibio1valW<LpacsetSpec> {
        Ahibio1valW::new(self, 18)
    }
}
