...
pub type AHIBIO1SCMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPACSET_SPEC, AHIBIO1SCMP_AW, O>;
impl<'a, const O: u8> AHIBIO1SCMP_W<'a, O> {
    #[doc = "No effect"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
pub type AHIBIO1VAL_W<'a, const O: u8> = crate::BitWriter<'a, u32, LPACSET_SPEC, AHIBIO1VAL_AW, O>;
impl<'a, const O: u8> AHIBIO1VAL_W<'a, O> {
    #[doc = "No effect"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahibio1scmp(&mut self) -> AHIBIO1SCMP_W<2> {
        AHIBIO1SCMP_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahibio1val(&mut self) -> AHIBIO1VAL_W<18> {
        AHIBIO1VAL_W::new(self)
    }
