...
pub type AHIBIO1SCMP_W<'a, REG> = crate::BitWriter<'a, REG, AHIBIO1SCMP_A>;
impl<'a, REG> AHIBIO1SCMP_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(AHIBIO1SCMP_A::VALUE1)
    }
    #[doc = "Start compare operation"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(AHIBIO1SCMP_A::VALUE2)
    }
}
...
pub type AHIBIO1VAL_W<'a, REG> = crate::BitWriter<'a, REG, AHIBIO1VAL_A>;
impl<'a, REG> AHIBIO1VAL_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "No effect"]
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(AHIBIO1VAL_A::VALUE1)
    }
    #[doc = "Above programmed threshold"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(AHIBIO1VAL_A::VALUE2)
    }
}
impl W {
