...
impl From<AHIBIO1SCMP_AW> for bool {
    ...
    fn from(variant: AHIBIO1SCMP_AW) -> Self {
        match variant {
            AHIBIO1SCMP_AW::VALUE1 => false,
            AHIBIO1SCMP_AW::VALUE2 => true,
        }
    }
}
#[doc = "Write proxy for field `AHIBIO1SCMP`"]
...
impl From<AHIBIO1VAL_AW> for bool {
    ...
    fn from(variant: AHIBIO1VAL_AW) -> Self {
        match variant {
            AHIBIO1VAL_AW::VALUE1 => false,
            AHIBIO1VAL_AW::VALUE2 => true,
        }
    }
}
#[doc = "Write proxy for field `AHIBIO1VAL`"]
