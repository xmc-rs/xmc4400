...
pub type AHIBIO1LO_R = crate::FieldReader<u8, u8>;
#[doc = "Field `AHIBIO1LO` writer - Analog HIB_IO_1 Lower Threshold Value"]
pub type AHIBIO1LO_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPACTH1_SPEC, u8, u8, 6, O>;
#[doc = "Field `AHIBIO1HI` reader - Analog HIB_IO_1 Upper Threshold Value"]
pub type AHIBIO1HI_R = crate::FieldReader<u8, u8>;
#[doc = "Field `AHIBIO1HI` writer - Analog HIB_IO_1 Upper Threshold Value"]
pub type AHIBIO1HI_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LPACTH1_SPEC, u8, u8, 6, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ahibio1lo(&mut self) -> AHIBIO1LO_W<16> {
        AHIBIO1LO_W::new(self)
    }
    #[doc = "Bits 24:29 - Analog HIB_IO_1 Upper Threshold Value"]
    #[inline(always)]
    #[must_use]
    pub fn ahibio1hi(&mut self) -> AHIBIO1HI_W<24> {
