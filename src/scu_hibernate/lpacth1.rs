...
impl W {
    ...
    #[doc = "Bits 16:21 - Analog HIB_IO_1 Lower Threshold Value"]
    #[inline(always)]
    pub fn ahibio1lo(&mut self) -> AHIBIO1LO_W<'_, LPACTH1_SPEC> {
        AHIBIO1LO_W::new(self, 16)
    }
    #[doc = "Bits 24:29 - Analog HIB_IO_1 Upper Threshold Value"]
    #[inline(always)]
    pub fn ahibio1hi(&mut self) -> AHIBIO1HI_W<'_, LPACTH1_SPEC> {
        AHIBIO1HI_W::new(self, 24)
    }
}
