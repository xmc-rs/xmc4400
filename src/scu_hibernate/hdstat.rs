...
impl From<AHIBIO1PEV_A> for bool {
    ...
    fn from(variant: AHIBIO1PEV_A) -> Self {
        match variant {
            AHIBIO1PEV_A::VALUE1 => false,
            AHIBIO1PEV_A::VALUE2 => true,
        }
    }
}
#[doc = "Reader of field `AHIBIO1PEV`"]
pub type AHIBIO1PEV_R = crate::R<bool, AHIBIO1PEV_A>;
impl AHIBIO1PEV_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl From<AHIBIO1NEV_A> for bool {
    ...
    fn from(variant: AHIBIO1NEV_A) -> Self {
        match variant {
            AHIBIO1NEV_A::VALUE1 => false,
            AHIBIO1NEV_A::VALUE2 => true,
        }
    }
}
#[doc = "Reader of field `AHIBIO1NEV`"]
pub type AHIBIO1NEV_R = crate::R<bool, AHIBIO1NEV_A>;
impl AHIBIO1NEV_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
