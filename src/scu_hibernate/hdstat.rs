...
pub type Ahibio1pevR = crate::BitReader<Ahibio1pev>;
impl Ahibio1pevR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Ahibio1pev {
        match self.bits {
            false => Ahibio1pev::Value1,
            true => Ahibio1pev::Value2,
        }
    }
    #[doc = "Wake-up on rising above threshold event inactive"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        *self == Ahibio1pev::Value1
    }
    #[doc = "Wake-up on rising above threshold event active"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        *self == Ahibio1pev::Value2
    }
}
...
pub type Ahibio1nevR = crate::BitReader<Ahibio1nev>;
impl Ahibio1nevR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Ahibio1nev {
        match self.bits {
            false => Ahibio1nev::Value1,
            true => Ahibio1nev::Value2,
        }
    }
    #[doc = "Wake-up on falling below threshold event inactive"]
    #[inline(always)]
    pub fn is_value1(&self) -> bool {
        *self == Ahibio1nev::Value1
    }
    #[doc = "Wake-up on falling below threshold event active"]
    #[inline(always)]
    pub fn is_value2(&self) -> bool {
        *self == Ahibio1nev::Value2
    }
}
impl R {
