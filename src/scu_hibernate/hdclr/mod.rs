...
#[doc = "Values that can be written to the field `AHIBIO1PEV`"]
pub enum AHIBIO1PEVW {
    #[doc = "No effect"]
    VALUE1,
    #[doc = "Clear wake-up event"]
    VALUE2,
...
impl AHIBIO1PEVW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            AHIBIO1PEVW::VALUE1 => false,
            AHIBIO1PEVW::VALUE2 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _AHIBIO1PEVW<'a> {
    w: &'a mut W,
}
impl<'a> _AHIBIO1PEVW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: AHIBIO1PEVW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn value1(self) -> &'a mut W {
        self.variant(AHIBIO1PEVW::VALUE1)
    }
    #[doc = "Clear wake-up event"]
    #[inline]
    pub fn value2(self) -> &'a mut W {
        self.variant(AHIBIO1PEVW::VALUE2)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `AHIBIO1NEV`"]
pub enum AHIBIO1NEVW {
    #[doc = "No effect"]
    VALUE1,
    #[doc = "Clear wake-up event"]
    VALUE2,
...
impl AHIBIO1NEVW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            AHIBIO1NEVW::VALUE1 => false,
            AHIBIO1NEVW::VALUE2 => true,
        }
    }
}
#[doc = r" Proxy"]
pub struct _AHIBIO1NEVW<'a> {
    w: &'a mut W,
}
impl<'a> _AHIBIO1NEVW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: AHIBIO1NEVW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn value1(self) -> &'a mut W {
        self.variant(AHIBIO1NEVW::VALUE1)
    }
    #[doc = "Clear wake-up event"]
    #[inline]
    pub fn value2(self) -> &'a mut W {
        self.variant(AHIBIO1NEVW::VALUE2)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[inline]
    pub fn ahibio1pev(&mut self) -> _AHIBIO1PEVW {
        _AHIBIO1PEVW { w: self }
    }
    #[doc = "Bit 13 - Wake-Up on LPAC Negative Edge of HIB_IO_1 Threshold Crossing Clear"]
    #[inline]
    pub fn ahibio1nev(&mut self) -> _AHIBIO1NEVW {
        _AHIBIO1NEVW { w: self }
    }
}
