...
impl W {
    ...
    #[inline(always)]
    pub fn dsd(&mut self) -> DSD_W<'_, CGATSET0_SPEC> {
        DSD_W::new(self, 1)
    }
    ...
    #[inline(always)]
    pub fn ccu42(&mut self) -> CCU42_W<'_, CGATSET0_SPEC> {
        CCU42_W::new(self, 4)
    }
    ...
    #[inline(always)]
    pub fn ccu81(&mut self) -> CCU81_W<'_, CGATSET0_SPEC> {
        CCU81_W::new(self, 8)
    }
    ...
    #[inline(always)]
    pub fn posif1(&mut self) -> POSIF1_W<'_, CGATSET0_SPEC> {
