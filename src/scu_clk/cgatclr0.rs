...
pub type DSD_W<'a, REG> = crate::BitWriter<'a, REG, DSD_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(DSD_A::VALUE1)
    }
    #[doc = "Disable gating"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(DSD_A::VALUE2)
    }
}
...
pub type CCU42_W<'a, REG> = crate::BitWriter<'a, REG, CCU42_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(CCU42_A::VALUE1)
    }
    #[doc = "Disable gating"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(CCU42_A::VALUE2)
    }
}
...
pub type CCU81_W<'a, REG> = crate::BitWriter<'a, REG, CCU81_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(CCU81_A::VALUE1)
    }
    #[doc = "Disable gating"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(CCU81_A::VALUE2)
    }
}
...
pub type POSIF1_W<'a, REG> = crate::BitWriter<'a, REG, POSIF1_A>;
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn value1(self) -> &'a mut crate::W<REG> {
        self.variant(POSIF1_A::VALUE1)
    }
    #[doc = "Disable gating"]
    #[inline(always)]
    pub fn value2(self) -> &'a mut crate::W<REG> {
        self.variant(POSIF1_A::VALUE2)
    }
}
...
impl W {
    ...
    #[inline(always)]
    pub fn dsd(&mut self) -> DSD_W<'_, CGATCLR0_SPEC> {
        DSD_W::new(self, 1)
    }
    ...
    #[inline(always)]
    pub fn ccu42(&mut self) -> CCU42_W<'_, CGATCLR0_SPEC> {
        CCU42_W::new(self, 4)
    }
    ...
    #[inline(always)]
    pub fn ccu81(&mut self) -> CCU81_W<'_, CGATCLR0_SPEC> {
        CCU81_W::new(self, 8)
    }
    ...
    #[inline(always)]
    pub fn posif1(&mut self) -> POSIF1_W<'_, CGATCLR0_SPEC> {
