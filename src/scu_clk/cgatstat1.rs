...
pub struct CCU43_R(crate::FieldReader<bool, CCU43_A>);
impl CCU43_R {
    pub(crate) fn new(bits: bool) -> Self {
        CCU43_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for CCU43_R {
    type Target = crate::FieldReader<bool, CCU43_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
