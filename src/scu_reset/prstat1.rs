...
pub struct CCU43RS_R(crate::FieldReader<bool, CCU43RS_A>);
impl CCU43RS_R {
    pub(crate) fn new(bits: bool) -> Self {
        CCU43RS_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for CCU43RS_R {
    type Target = crate::FieldReader<bool, CCU43RS_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
